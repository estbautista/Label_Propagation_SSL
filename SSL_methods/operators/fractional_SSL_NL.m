...
% Tue Oct 24 21:37:14 CEST 2017
%
% Last edited on: 
% Tue Oct 24 21:37:21 CEST 2017
%
% Usage: [operator, estimation, classification] = fractional_SSL_NL(A, mu, gamma, Y,varargin);
% Computes the fractional SSL classification for the Normalized Laplacian method 
%
% INPUT: 
...
function [operator, estimation, classification] = fractional_SSL_NL(A, mu, gamma, Y, varargin)
...
if nargin == 3
operator = ((1-alpha)*eye(N)) / (eye(N) - alpha*Dg^(-0.5)*Ag*Dg^(-0.5));
end
