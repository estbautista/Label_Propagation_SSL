...
% Tue Oct 24 21:35:22 CEST 2017
%
% Last edited on: 
% Tue Oct 24 21:35:27 CEST 2017
%
% Usage: [operator, estimation, classification] = fractional_SSL_PR(A, mu, gamma, Y, varargin);
% Computes the fractional SSL classification for the PageRank method 
%
% INPUT: 
...
function [operator, estimation, classification] = fractional_SSL_PR(A, mu, gamma, Y, varargin)
...
if nargin == 3
operator = ((1-alpha)*eye(N)) / (eye(N) - alpha*Ag*Dg^(-1));
end
